...
void MC33926::setPins(uint8_t PWMPin, uint8_t direction, uint8_t feedback,
...
void MC33926::invertDirection(bool state) { directionInversionFlag = state; }

bool MC33926::isDirectionInverted() const { return directionInversionFlag; }